...
values ('user_client_app', '{bcrypt}$2a$10$.hgHhFL05qsstVVnCIFvx.AqRwTS6d/C0Wo./YYz42n0ajwLFz3vS',
...
values ('abb71127-9100-4b90-aeee-08d68d7ef4ec','role_admin'),
       ('505e41f3-77fc-4bbc-afde-1873f26dcb30','role_user');
...
values ('47f0e09c-1324-4f24-bf2f-d663c7279042', 'abb71127-9100-4b90-aeee-08d68d7ef4ec'),
       ...
       ('c66bd23a-c0c1-467f-954c-8ae389d6c333', '505e41f3-77fc-4bbc-afde-1873f26dcb30');

insert into "user" (id,name, pwd,
                  email, enabled, account_expired, credentials_expired, account_locked)
values ('aea6c140-5047-4273-a80e-9a8e21bd6904','admin', '{bcrypt}$2a$10$.hgHhFL05qsstVVnCIFvx.AqRwTS6d/C0Wo./YYz42n0ajwLFz3vS',
        'viudes@gmail.com', true, false,false,false),
       ('8061b27b-26f0-426a-9549-cef54b5dc52f','user', '{bcrypt}$2a$10$.hgHhFL05qsstVVnCIFvx.AqRwTS6d/C0Wo./YYz42n0ajwLFz3vS',
        'viudes2@gmail.com', true, false, false, false);

insert into role_user (role_id, user_id)
values ('abb71127-9100-4b90-aeee-08d68d7ef4ec','aea6c140-5047-4273-a80e-9a8e21bd6904' ) ,
       ('505e41f3-77fc-4bbc-afde-1873f26dcb30','8061b27b-26f0-426a-9549-cef54b5dc52f')  ;
